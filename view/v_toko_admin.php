...
<html>
    <head>
        <meta charset="utf-8">
        <title>Toko <?php echo $nama_toko; ?> - Admin</title>
    ...
    <body>
        ...
        <h1 class="filter">Selamat Datang, <?php echo $username; ?> di toko <?php echo $nama_toko; ?></h1>
        <h2 class="filter">Daftar Produk <a class="btn btn-default" href="?a_toko=<?php echo $_GET['a_toko']; ?>&tambah_produk" role="button"><i class="glyphicon glyphicon-plus"></i></a></h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="btn-group" role="group">
									...
									<a class="btn btn-default" href="?a_toko=<?php echo $_GET['a_toko']; ?>&edit_produk=<?php echo $produk['id_produk'];?>"><i class="glyphicon glyphicon-edit"></i></a>
								</div>
                            </div>
                        </div>
                    </div>
